...
class n_arbitrage:
	...
	def __init__(self):
		...
		self.symbols = ['USDT', 'BUSD', '1INCH', 'AAVE', 'ACA', 'ADA', 'ADADOWN', 'ADAUP', 'ADX', 'ALGO', 'ALICE', 'ANKR',
						...
						'ROSE', 'RUB', 'RUNE', 'RVN', 'SAND', 'SHIB', 'SLP', 'SNX', 'SOL', 'SPELL', 'SRM', 'SUN',
						'SUPER', 'SUSHI', 'SXP', 'SYS', 'TFUEL', 'THETA', 'TLM', 'TROY', 'TRX', 'TRY', 'TUSD', 'UNFI',
						'UNI', 'USDC', 'UST', 'VET', 'WAVES', 'WAXP', 'WBTC', 'WIN', 'WTC', 'XLM', 'XMR', 'XRP',
						'XTZ', 'YFI', 'YGG', 'ZEC', 'ZEN', 'ZIL']
		# OFF BNB, BUSD
	...
	def get_triangle_profit_by_spread(self, arb):
		arb_len = len(arb)
		self.triangle_profit_result = (1-(self.spread / 100)) ** (arb_len - 1)
		for i_arb in range(arb_len - 1):
			self.triangle_profit_result *= self.convert_multiplier[arb[i_arb] + arb[i_arb + 1]]
